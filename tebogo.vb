...
Public Class Form1
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            Dim ContactDetailstable As New Data.DataTable

            dbconnect.ConnectionString = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source= C:\Users\Student\Desktop\PhoneBook.mdb ;user id = ; password = ;"
            dbconnect.Open()
            command.Connection = dbconnect
            command.CommandText = "SELECT * FROM ContactDetails"
            ContactDetailstable.Load(command.ExecuteReader())

            dbconnect.Close()

            DataGridView1.DataSource = ContactDetailstable
    ...
    Private Sub btnSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        Try
            ...
            If ContactDetailstable.Rows.Count = 0 Then
                MessageBox.Show("No Contact found, Re-enter")
            ElseIf ContactDetailstable.Rows.Count = 1 Then
                txtName.Text = ContactDetailstable.Rows(0)("Name")
                txtSurname.Text = ContactDetailstable.Rows(0)("Surname")
                txtCellnumber.Text = ContactDetailstable.Rows(0)("cellNumber")
            End If
